...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$10$JW8X2dnl1yVas/mAPocMre.UHhzqZOUvq6PRHa/sNM8bMkI/0ZL6.', 1);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (7, 'Ivan', 'Ivanov', 'ivanov@mail.com', '$2a$10$8m6.jHWo/qTFELi5ZXkMw.Tpgk4ZfnubA4zoSx.2Jq/t2Psas1IA6', 1);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (5, 'Nick', 'Green', 'nick@mail.com', '$2a$10$pokFWEYW/cxqwbNHfIVnrucYRTHSQmPWUCevLByvnOwXEoQQuxy7a', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (6, 'Nora', 'White', 'nora@mail.com', '$2a$10$e8h2bu.nJbkaF5qoFF556um/1o9gOvlLXfrvyeU3UvpQKYqn/DX22', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (8, 'Igor', 'Igorev', 'igorev@mail.com', '$$2a$10$a23.Q4ddMn/CKmfhEYoYtePhuX5Xt3LehneVtA9tUxassOHb.r5QO', 2);
